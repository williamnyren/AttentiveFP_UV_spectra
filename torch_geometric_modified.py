...
x_map_one_hot: Dict[str, List[Any]] = {
    ...
    list(range(0, 119)),
    'chirality': {
        'CHI_UNSPECIFIED':[1, 0, 0, 0, 0, 0, 0, 0, 0],
        'CHI_TETRAHEDRAL_CW':[0, 1, 0, 0, 0, 0, 0, 0, 0],
        'CHI_TETRAHEDRAL_CCW':[0, 0, 1, 0, 0, 0, 0, 0, 0],
        'CHI_OTHER':[0, 0, 0, 1, 0, 0, 0, 0, 0],
        'CHI_TETRAHEDRAL':[0, 0, 0, 0, 1, 0, 0, 0, 0],
        'CHI_ALLENE':[0, 0, 0, 0, 0, 1, 0, 0, 0],
        'CHI_SQUAREPLANAR':[0, 0, 0, 0, 0, 0, 1, 0, 0],
        'CHI_TRIGONALBIPYRAMIDAL':[0, 0, 0, 0, 0, 0, 0, 1, 0],
        'CHI_OCTAHEDRAL':[0, 0, 0, 0, 0, 0, 0, 0, 1]
        },
    'degree':
    list(range(0, 11)),
    'formal_charge':
    ...
    list(range(0, 5)),
    'hybridization': {
        'UNSPECIFIED': [1, 0, 0, 0, 0, 0, 0, 0],
        'S': [0, 1, 0, 0, 0, 0, 0, 0],
        'SP': [0, 0, 1, 0, 0, 0, 0, 0],
        'SP2': [0, 0, 0, 1, 0, 0, 0, 0],
        'SP3': [0, 0, 0, 0, 1, 0, 0, 0],
        'SP3D': [0, 0, 0, 0, 0, 1, 0, 0],
        'SP3D2': [0, 0, 0, 0, 0, 0, 1, 0],
        'OTHER': [0, 0, 0, 0, 0, 0, 0, 1]
        },
    'is_aromatic': {False: [0,1], True: [1,0]},
    'is_in_ring': {False:[0,1], True:[1,0]}
}
...
e_map_one_hot: Dict[str, List[Any]] = {
    'bond_type': {
        ...
        'AROMATIC':[0,0,0,0,0,1.0,0],
        'LONGRANGE':[0,0,0,0,0,0,1.0],
        },
    ...
    'is_conjugated': {False:[0,1.0], True:[1.0,0]},
    'is_aromatic': {False:[0,1.0], True:[1.0,0]},
    'is_in_ring': {False:[0,1.0], True:[1.0,0]},
}
def node_encoding(mol, x_map, one_hot = False):
    ...
    return x
def edge_encoding(mol, e_map, one_hot = False):
...
def from_smiles(smiles: str, with_hydrogen: bool = False,
    ...
    edge_index, edge_attr = edge_encoding(mol, e_map, one_hot)
